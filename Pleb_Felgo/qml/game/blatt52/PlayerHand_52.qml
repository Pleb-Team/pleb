...
Item {
  ...
  function neatHand(){
    ...
    if (hand.length > 7){
      offset = playerHand52.originalWidth * zoom / hand.length / 1.5
    }
    ...
    for (var i = 0; i < hand.length; i ++){
      ...
      var cardX = (playerHand52.originalWidth * zoom - handWidth) / 2 + (i * offset)
  ...
  function scaleHand(scale){
    zoom = scale
    playerHand52.height = playerHand52.originalHeight * zoom
    playerHand52.width = playerHand52.originalWidth * zoom
    for (var i = 0; i < hand.length; i ++){
